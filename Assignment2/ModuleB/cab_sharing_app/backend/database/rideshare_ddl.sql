...
CREATE TABLE IF NOT EXISTS Members (
    ...
    GoogleSub       VARCHAR(255) NOT NULL UNIQUE,          -- Added: OAuth identifier
...
CREATE TABLE IF NOT EXISTS ActiveRides (
    RideID          VARCHAR(50) PRIMARY KEY,
    AdminID         INT NOT NULL,
    AvailableSeats  INT NOT NULL CHECK (AvailableSeats >= 0),
    PassengerCount  INT NOT NULL DEFAULT 1 CHECK (PassengerCount >= 1),
    ...
    Status          VARCHAR(20) NOT NULL DEFAULT 'ACTIVE',  -- Added: ride state management
...
CREATE TABLE IF NOT EXISTS MessageHistory (
    ...
    MessageText     VARCHAR(500) NOT NULL,                  -- Changed: TEXT → VARCHAR(500)
...
CREATE TABLE IF NOT EXISTS RideFeedback (
    ...
    FeedbackText    VARCHAR(500) NOT NULL,                  -- Changed: TEXT → VARCHAR(500)
...
CREATE TABLE IF NOT EXISTS Cancellation (
    CancellationID      INT PRIMARY KEY AUTO_INCREMENT,     -- Added: surrogate PK
    RideID              VARCHAR(50) NOT NULL,
    MemberID            INT NOT NULL,
